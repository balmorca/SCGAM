        ...
        <?php include "header.php"; ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Activos Asignados</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo htmlentities($totalstudents);?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <?php 
                                $sql2 ="SELECT id from  tblusuarios";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo htmlentities($totalclasses);?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo htmlentities($totalclasses);?></div>
                                                </div>
                                                <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Movimientos De Equipos</h6>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Asignados Por Empresas</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> BALMORCA
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-warning"></i> ASESORIA
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> ALMARCA
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-danger"></i> GADO
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> INVERSIONES
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> COALMAR
                                        </span>
                                    </div>
                                </div>
                            </div>
