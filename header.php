...
?>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <hr class="sidebar-divider">
                <li class="nav-item">
                    <a class="nav-link collapsed" type="button" data-toggle="collapse" data-target="#menuempresas"
                    ...
                    <div id="menuempresas" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <?php if (isset($_SESSION['user_userpermittify'])) {
                                foreach ($resultados as $rows) { ?>
                                    <?php mostrarMensajes($errors); ?>
                                    <form action="Consult_Empresa.php" method="POST">
                                        <input type="hidden" name="id_interno" value="<?php echo $rows[('id_interno')];?>">
                                        <button type="submit" class="btn btn-light" style="width: 100%;">
                                            <a style="margin: 2px;"><?php echo $rows[('nombre_corto')]; ?></a>
                                        </button>
                                    </form>
            ...
            <hr class="sidebar-divider">
                <li class="nav-item">
                    <a class="nav-link collapsed" type="button" data-toggle="collapse" data-target="#Mantenimiento"
                        aria-expanded="true" aria-controls="collapsemant">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-filter-left" viewBox="0 0 16 16">
                            <path d="M2 10.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5m0-3a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5"/>
                        </svg>
                    ...
                    <div id="Mantenimiento" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="Config_Empresas.php">Configuración de <br> Empresas</a>
                            <a class="collapse-item" href="Config_Usuarios.php">Configuración de <br> Usuarios</a>
                        </div>
                    </div>
                </li>
                <hr class="sidebar-divider">
                <li class="nav-item">
                    <a class="nav-link collapsed" type="button" data-toggle="collapse" data-target="#collapse" aria-expanded="true" aria-controls="collapse">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-filter-left" viewBox="0 0 16 16">
                            <path d="M2 10.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5m0-3a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5"/>
                        </svg>
