<?php
    ...
    #print_r($_SESSION);
    #print_r($_POST);
    $_SESSION['id_internotify'] = $empresa['id_interno'];
    $_SESSION['id_namecortotify'] = $empresa['nombre'];
?>
...
<head>
    ...
    <title><?php echo $_SESSION['id_namecortotify']; ?></title>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Balmorca 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
